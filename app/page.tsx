      ...
      <div className="px-4 mt-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-3 bg-zinc-900 border border-zinc-700 rounded-xl text-white placeholder-zinc-600 focus:outline-none focus:border-amber-500 font-mono text-base transition-colors"          />
          {search && (
